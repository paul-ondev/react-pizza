        ...
        <div className="cart-block">
                ...
                <div className="cart-block-top__title">
                    <div className="cart-block-top__cart-icon">
                        ...
                        <div className="cart-icon__wheels">
                            ...
                            <path d="M4.16667 6.79167C5.50136 6.79167 6.58334 5.70969 6.58334 4.37501C6.58334 3.04032 5.50136 1.95834 4.16667 1.95834C2.83198 1.95834 1.75 3.04032 1.75 4.37501C1.75 5.70969 2.83198 6.79167 4.16667 6.79167Z" stroke="#3F3F3F" strokeWidth="2.8" strokeLinecap="round" strokeLinejoin="round"/>
                            </svg>
            ...
            <footer className="cart-block-bottom">
                <div className="cart-block-bottom__total-info">
                    <div className="cart-block-bottom__total-amount">Всего пицц: <b>{totalAmount ? totalAmount : '0'} шт.</b></div>
